...
S {}
E {}
N 390 -210 390 -180 { lab=Vb4_}
N 390 -150 390 -120 { lab=GND}
N 430 -150 520 -150 { lab=Vb4_}
N 390 -190 450 -190 { lab=Vb4_}
N 450 -190 450 -150 { lab=Vb4_}
N 580 -150 600 -150 { lab=Vb4}
N 600 -150 700 -150 { lab=Vb4}
N 700 -150 800 -150 { lab=Vb4}
...
C {devices/lab_wire.sym} 800 -150 0 1 {name=l60 sig_type=std_logic lab=Vb4}
C {devices/lab_wire.sym} 390 -210 0 1 {name=l1 sig_type=std_logic lab=Vb4_}
C {devices/iopin.sym} 210 -90 0 0 {name=p4 lab=GND}
C {devices/iopin.sym} 210 -120 0 0 {name=p1 lab=Vb4_}
C {devices/opin.sym} 210 -150 0 0 {name=p2 lab=Vb4}
